...
class EmployeeController extends Controller
{
    public function index(){
        ...
        // dd($roles);
        return view('Super-Admin.employees', compact('hospitalName','roles','employees'));
    }
    ...
    public function create(){
        ...
        $hospitalName = session()->get('hospitalName');
        return view('Super-Admin.add_employee', compact('hospitalName','departments'));
    }
    ...
    public function edit(Employee $employee)
    {
        ...
        $hospitalID = session()->get('hospitalID');
        $departments = Department::where('hospital_id', $hospitalID)->get(['id','name']);
        return view('Super-Admin.edit_employee', compact('employee', 'hospitalName','departments'));
    }
