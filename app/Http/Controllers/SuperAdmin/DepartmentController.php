...
class DepartmentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Super-Admin.departments', compact('hospitalName','departments'));
    }
    ...
    {
        $hospitalName = session()->get('hospitalName');
        return view('Super-Admin.add_department', compact('hospitalName'));
    }
    ...
    {
        $hospitalName = session()->get('hospitalName');
        return view('Super-Admin.edit_department', compact('department', 'hospitalName'));
    }
