...
class SuperAdminController extends  Controller
{
    ...
    public function index(){
        ...
        $numOfHospitals = Hospital::where('id','!=',$hospitalID )->count();

        // 

        $hospitalName = session()->get('hospitalName');
    
        return view('Super-Admin.index', compact('numOfDoctors','numOfNurses','numOfReceptionists','hospitalName','numOfPatients','numOfHospitals'));
    }
