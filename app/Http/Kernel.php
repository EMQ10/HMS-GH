...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'AllAppUsersAuth' => \App\Http\Middleware\AllAppUsersAuth::class,
        'DoctorAuth' => \App\Http\Middleware\DoctorAuth::class,
        'NurseAuth' => \App\Http\Middleware\NurseAuth::class,
        'ReceptionistAuth' => \App\Http\Middleware\ReceptionistAuth::class,
