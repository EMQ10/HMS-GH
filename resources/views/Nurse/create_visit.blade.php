...
@section('title')
    <title>Create Visit - Health Care</title>
@endsection
...
<div class="content">
    <div class="row">
        <div class="col-lg-8 offset-lg-2">
            <h4 class="page-title">Create Visit</h4>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-8 offset-lg-2">
            ...
            <form action="{{ route('nurse.visit.store') }}" method="POST">
                @csrf
                <div class="row mb-5 border p-3">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="patient_reg_number" value="{{ old('patient_reg_number') }}">
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text"  name="receipt_number" value="{{ old('receipt_number') }}">
                        </div>
                ...
                <div class="m-t-20 text-center mb-4">
                    <button class="btn btn-primary submit-btn">Create visit</button>
                </div>
            </form>
        </div>
    </div>
