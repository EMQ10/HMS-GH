...
<div class="content" style="font-size:22px;">
    <div class="row">
        ...
        <div class="col-sm-7 col-7 text-right m-b-30">
            <a href="{{ route('admin.departments.create') }}" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Add Department</a>
        </div>
    </div>
                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="{{ route('admin.departments.edit', $department->id) }}"><i class="fa fa-magic"></i> Edit</a>
