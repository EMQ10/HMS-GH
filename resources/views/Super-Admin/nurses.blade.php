                ...
                <div class="profile-widget">
                    ...
                    <div class="dropdown profile-action">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{ route('superadmin.employees.edit', $nurse->employee->id) }}"><i class="fa fa-magic"></i> &nbsp; Edit</a>
                            {{-- <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_doctor"><i class="fa fa-trash-o m-r-5"></i> Delete</a> --}}
                        </div>
                    </div>
                    <h4 class="doctor-name text-ellipsis"><a href="profile.html">{{ $nurse->employee->first_name }} {{  $nurse->employee->middle_name ?? "" }} {{ $nurse->employee->last_name }}</a></h4>
                    
                        <div class="doc-prof">{{ $nurse->department->name }}</div>
